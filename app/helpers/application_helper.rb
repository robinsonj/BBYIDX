...
module ApplicationHelper
  ...
  # error_messages_for replacement from http://www.emersonlackey.com/article/rails3-error-messages-for-replacement.
  # Should be changed to reflect preferred stylings.
